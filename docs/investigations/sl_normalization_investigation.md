...
| STRESS | n/a | `slovenian.ts` emits no stress mark at all — Slovene stress is free, lexical and unwritten, and a stress lexicon is the deferred fix recorded in `sl_native_bringup_investigation.md`. Not this layer's seam. |
