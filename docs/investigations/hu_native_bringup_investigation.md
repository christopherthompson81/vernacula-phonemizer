...
- **REGRESSIVE voicing assimilation** (+12.5pp) — an obstruent takes the voicing of a following obstruent:
  ...
  wikipron (92.6%) against our now-correct output — the naive referee, not us.
...
**92.6% vs wikipron / 87.6% vs epitran.** Two independent referees; the human wikipron is the authoritative one and
...
human at 92.6%). Numbers (one-word compounds, huszon-/tizen- bound tens, 2→két before a scale) are done.
