...
The findings register (now `docs/investigations/csharp-port/csharp_port_findings_investigation.md`) records that bho had **six wrong claims** in its manifest. `magahi.jsonc` was derived from
