...
same failure the `docs/investigations/normalization/south_slavic_stress_sources_investigation.md` header records for the stress audit — "the
...
**Question.** After the elevated-median work (`docs/investigations/referee/low_vowel_notation_investigation.md`),
...
**→ Measured and REJECTED at 0.11:1** — see `docs/investigations/normalization/uppercase_latin_default_investigation.md`.
...
`docs/investigations/referee/low_vowel_notation_investigation.md` proposed three changes on recognizer evidence and withdrew all
