...
| **de** German | 66.0% (.60) | wikipron 66.3% | 🟡 | Mature core (9 runs, all kaikki-derived: compound splitter + per-position length + full unstressed-vowel QUALITY lexicon covering reduction AND loanword lax→tense). Runs 7/9 closed the big levers (independent wikipron 52→66%). Remaining tail is compound-seam st→ʃt/d→t (needs the splitter to fire on more constituents) + fine loanword consonants. Referee still loan/proper-noun deflated. |
