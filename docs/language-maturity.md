...
| **cmn** Mandarin | 84.7% (.80) | CC-CEDICT 97.3%rd | 🟡 | Hanzi front-end BUILT (phrase+char dicts, polyphones, 一/不 + 3-3 sandhi, numbers/year/decimal, Latin→en). Independently validated vs CC-CEDICT (124k, non-pypinyin): **97.3% reading / 92.8% full** — reading misses are rare/obscure chars (noise); the tone gap is mostly neutral-tone convention + our (correct) 一/不 sandhi vs CC-CEDICT citation. Tail = ~2% genuine tone-polyphones (趟, 打, 更) closeable by dict fixes. The epitran 84.7% is syllable→IPA only. Untested: cross-word CONTEXT polyphones (phrase dict covers common cases). |
