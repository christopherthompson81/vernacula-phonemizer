...
A **canonical-IPA** phonemizer for **134 languages** — native, cleanroom, and self-contained.
...
134 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Armenian, Austroasiatic,
