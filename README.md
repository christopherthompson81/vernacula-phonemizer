...
A **canonical-IPA** phonemizer for **81 languages** — native, cleanroom, and self-contained.
...
81 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
