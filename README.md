...
A **canonical-IPA** phonemizer for **133 languages** — native, cleanroom, and self-contained.
...
133 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Armenian, Austroasiatic,
