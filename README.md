...
A **canonical-IPA** phonemizer for **87 languages** — native, cleanroom, and self-contained.
...
87 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
