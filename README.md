...
A **canonical-IPA** phonemizer for **69 languages** — native, cleanroom, and self-contained.
...
69 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
