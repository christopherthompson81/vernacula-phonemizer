...
A **canonical-IPA** phonemizer for **70 languages** — native, cleanroom, and self-contained.
...
70 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
