...
A **canonical-IPA** phonemizer for **74 languages** — native, cleanroom, and self-contained.
...
74 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
