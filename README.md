...
A **canonical-IPA** phonemizer for **82 languages** — native, cleanroom, and self-contained.
...
82 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
