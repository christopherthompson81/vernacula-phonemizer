...
A **canonical-IPA** phonemizer for **71 languages** — native, cleanroom, and self-contained.
...
71 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
