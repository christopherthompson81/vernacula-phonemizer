...
A **canonical-IPA** phonemizer for **77 languages** — native, cleanroom, and self-contained.
...
77 languages spanning Afroasiatic (Semitic, Cushitic, Chadic), Austroasiatic, Austronesian,
