...
(needs network). Eval the tagger against it with tools/persian/ge2pe-eval.ts."""
...
HDR = [
 ...
 "# Build/eval: tools/persian/ge2pe_referee.py + ge2pe-eval.ts. Graphemes normalized Arabic→Farsi.",
]
out = sys.stdout
