 ...
 *   npx tsx tools/arabic-restorer/build_cle_referee.ts   # → tools/referee-eval/referees/ur.cle-speech.tsv
 */
...
writeFileSync(OUT, "# CLE Lahore Phonetically Rich Urdu Speech Corpus (human read-speech, CISAMPA→IPA) — INDEPENDENT of\n" +
    "# Wiktionary. Word-aligned from the corpus transcriptions. CC-licensed. Build: tools/arabic-restorer/build_cle_referee.ts.\n" +
    rows.join("\n") + "\n");
