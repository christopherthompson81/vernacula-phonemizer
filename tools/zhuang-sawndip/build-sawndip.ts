 ...
 *
 * Usage: npx tsx tools/zhuang-sawndip/build-sawndip.ts [--write]
 */
...
if (process.argv.includes("--write")) {
    const header = "# Sawndip glyph → Standard-Zhuang reading (Latin). Built by tools/zhuang-sawndip/build-sawndip.ts from the\n# kaikki Zhuang extract. Polyphonic glyphs use a most-common default (most senses); routed through the za engine.\n";
