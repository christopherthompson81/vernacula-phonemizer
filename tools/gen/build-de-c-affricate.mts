 ...
 * data/languages/german/consonant.tsv by build-de-consonant.mts.
 *
 ...
 * TRUNCATES data/languages/german/consonant.tsv first, so that `phonemizeWord` compares against the RAW
...
const hdr =
    ...
    "# tools/gen/build-de-c-affricate.mts; merged into data/languages/german/consonant.tsv by\n" +
