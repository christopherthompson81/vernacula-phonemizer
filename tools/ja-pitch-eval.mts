 ...
 * For each complete content word the committed gold (tools/ja_pitch_reference.tsv) carries OpenJTalk's accent
 ...
 *
 *   npx tsx tools/ja-pitch-eval.mts            # score
 *   npx tsx tools/ja-pitch-eval.mts --list     # + list accent disagreements
 */
