...
```bash
npx tsx tools/referee-eval/eval.ts <ar|cmn|cs|de|en|es|ff|fr|ha|hi|ja|kk|ko|pt|ru|si|sv|ta|th|tr|vi|zu> [--examples N]
...
**hi 77.7%** · **ta 63.0%** · **tr 76.2%** (epitran 79.8%) · **ru 94.8%** (gold 97.7%) · **si 93.5%** · **sv 52.6%** (Phase 3, NST accent+stress+o-quality lexicon) ·
