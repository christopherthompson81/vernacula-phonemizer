...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.52, // kaikki deu — measured 57.4% (wikipron deu 2nd: 58.1%); Run 7 added the kaikki-derived unstressed-e→ə reduction lexicon (+6.5/+5.2, independently validated by wikipron); still DEFLATED by kaikki's proper-noun/loan bulk
