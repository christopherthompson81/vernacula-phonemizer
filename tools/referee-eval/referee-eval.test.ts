...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.74, // kaikki deu — measured 75.3% (wikipron deu 2nd: 74.8%); Run 25 restored a stressed bare ɐ to ɛʁ (wrongly-reduced -er: Laterne, Inferno). Residual now DOMINATED by proper-noun/loanword noise (haiti/alert/berlin/moslem) — the referee-limited tail
