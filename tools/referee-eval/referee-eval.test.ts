...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.74, // kaikki deu — measured 75.5% (wikipron deu 2nd: 74.8%); Run 26 recursed into prefixed compound constituents (wahn·vor·stellung → inner st → ʃt). Residual now DOMINATED by proper-noun/loanword noise (haiti/alert/berlin/moslem) — the referee-limited tail
