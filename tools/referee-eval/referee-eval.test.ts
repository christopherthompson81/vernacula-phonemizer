...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.70, // kaikki deu — measured 73.5% (wikipron deu 2nd: 72.8%); Run 17 added the i→ɪ/y→ʏ quality pair (unstressed -igen). Residual DEFLATED by kaikki's proper-noun/loan bulk
