...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.69, // kaikki deu — measured 72.9% (wikipron deu 2nd: 72.4%); Run 16 expanded kaikki syllabic n̩/l̩/m̩ in the lexicon builds → recovered ~2500 skewed -en entries (mid-compound reduction). Residual DEFLATED by kaikki's proper-noun/loan bulk
