...
describe("referee corroboration (segmental backbone vs the PRIMARY independent source)", () => {
  ...
  const floors: Record<string, number> = {
    ...
    de: 0.60, // kaikki deu — measured 66.0% (wikipron deu 2nd: 66.3%); Run 9 generalized the kaikki-derived lexicon to full unstressed-vowel QUALITY (reduction + loanword lax→tense); independently validated (wikipron +8.1). Residual DEFLATED by kaikki's proper-noun/loan bulk
