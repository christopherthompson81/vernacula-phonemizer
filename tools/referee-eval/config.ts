...
export const CONFIG: Record<string, RefLang> = {
    ...
    ar: {
        ...
        folds: [
            [
                /(.)\1+/gu,
                "$1",
                "gemination (shadda): collapse doubling — length already stripped by the backbone",
            ],
        ],
    },
    ca: {
        ...
        referees: [
            {
                file: "ca.wikipron-cat-narrow.tsv",
                source: "wikipron cat_latn narrow (human, multi-dialect)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; the referee mixes dialects and drops stress. A Central-only " +
        ...
        folds: [
            [
                /β/gu,
                "b",
                "spirantization β̞~b — ours marks it honestly; the referee varies",
            ],
            ...
            [
                /ɫ/gu,
                "l",
                "dark-l ɫ~l — ours velarized (Central), the referee writes plain l",
            ],
            ...
            [
                /[ɛe]/gu,
                "ə",
                "unstressed a/e → ə (Central) vs referee a/e; folds the reduction axis + lexical ɛ/e",
            ],
            [/a/gu, "ə", "unstressed a → ə (Central) vs referee unreduced a"],
            [
                /[ɔo]/gu,
                "u",
                "unstressed o → u (Central) vs referee o; + lexical ɔ/o",
            ],
            [
                /v/gu,
                "b",
                "betacism: Central merges v→b; the referee (multi-dialect) keeps v",
            ],
            [
                /dʒ/gu,
                "ʒ",
                "Catalan /dʒ~ʒ/ affrication is allophonic (metge dʒ ~ jo ʒ); tie already stripped, referee varies",
            ],
            [
                /[ɾr]$/gu,
                "",
                "final-r is a DIALECT axis: Central drops it (cantar→kənta), the referee (Valencian) keeps it",
            ],
        ],
    },
    cmn: {
        ...
        referees: [
            {
                file: "cmn.epitran-cmn-Latn.tsv",
                source: "epitran cmn-Latn pinyin-syllable inventory",
                role: "primary",
            },
        ],
        secondaryGap:
            "no word-level independent source: wikipron cmn is Hanzi-keyed (polyphone-ambiguous) and this " +
        ...
        preFolds: [
            [
                /[ʐzɻɹʑ]̩/gu,
                "ɹ̩",
                "apical/retroflex syllabic vowel (chi ʈʂʰʐ̩, si sɹ̩) unified before ̩ is stripped",
            ],
        ],
        folds: [
            ...
            [
                /[ɑä]/gu,
                "a",
                "/a/ allophones [a]~[ɑ]~[ä] by final (an/ang/ian) — we transcribe narrow, epitran broad",
            ],
            ...
            [
                /(.)\1+/gu,
                "$1",
                "collapse any doubling (no meaningful gemination in Mandarin)",
            ],
        ],
    },
    cs: {
    ...
    de: {
        referees: [
            {
                file: "de.kaikki-deu.tsv",
                source: "kaikki deu (Wiktionary, CC-BY-SA)",
                role: "primary",
            },
            {
                file: "de.wikipron-deu.tsv",
                source: "wikipron deu_latn broad (human)",
                role: "secondary",
            },
        ],
        ...
        preFolds: [
            ...
            [
                /ɐ̯/gu,
                "r",
                "vocalized-r ɐ̯ → r; normalize before ̯ is stripped (ours writes ʁ→r, referee ɐ̯)",
            ],
        ],
        folds: [
            [
    ...
    en: {
        ...
        referees: [
            {
                file: "en.wikipron-eng-latn-us-broad.tsv",
                source: "wikipron eng_latn_us broad (human, GenAm)",
                role: "primary",
            },
        ],
        secondaryGap:
            "epitran eng-Latn is itself CMU-derived — circular with our CMUdict-based g2p, so not independent.",
        segmentJoin: true,
        folds: [
            ...
            [
                /ɚ/gu,
                "əɹ",
                "r-coloured schwa ɚ vs referee ə + ɹ (the letter r written out)",
            ],
            [
                /ʰ/gu,
                "",
                "allophonic aspiration on voiceless stops — referee omits it",
            ],
    ...
    es: {
        referees: [
            {
                file: "es.wikipron-spa.tsv",
                source: "wikipron spa_latn_ca broad (human, Castilian)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; kaikki spa or a Latin-American wikipron would corroborate.",
        segmentJoin: true,
        folds: [
            [
                /β/gu,
                "b",
                "spirantization β̞~b — allophonic; referee may write either",
            ],
            ...
            [
                /r/gu,
                "ɾ",
                "trill/tap r~ɾ — referee inconsistent on rr vs intervocalic",
            ],
            [
                /ᶦ/gu,
                "i",
                "our non-syllabic offglide ᶦ (aire→aᶦɾe) vs referee plain i",
            ],
            [
                /ᶷ/gu,
                "u",
                "our non-syllabic offglide ᶷ (auto→aᶷto) vs referee plain u",
            ],
        ],
    },
    ff: {
        ...
        referees: [
            {
                file: "ff.epitran-ful-Latn.tsv",
                source: "epitran ful-Latn (programmatic; via espeak-ng-portable ff_gold)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second Fula source: wikipron ful/fuf are empty, so the only G2P is the primary.",
        preFolds: [
            [
                /ñ/gu,
                "ɲ",
                "epitran ⟨ñ⟩ → our ɲ; matches the NFD-decomposed n+◌̃ and runs before the backbone strips the tilde",
            ],
        ],
        folds: [
            [
                /c/gu,
                "tʃ",
                "epitran writes ⟨c⟩ where we render the affricate t͡ʃ",
            ],
            ...
            [
                /nj/gu,
                "ɲ",
                "epitran keeps orthographic nj; we render the prenasal palatal",
            ],
            ...
            [
                /(.)\1+/gu,
                "$1",
                "collapse geminate doubling — length already stripped by the backbone",
            ],
        ],
    },
    fr: {
        referees: [
            {
                file: "fr.wikipron-fra.tsv",
                source: "wikipron fra_latn broad (human)",
                role: "primary",
            },
            {
                file: "fr.gold-freq.tsv",
                source: "frequency-ranked adjudicated gold (3k, our convention)",
                role: "secondary",
            },
        ],
        segmentJoin: true,
        folds: [
            [
                /ə/gu,
                "",
                "optional/final schwa — the referee is inconsistent on mute-e",
            ],
        ],
    },
    ga: {
        ...
        referees: [
            {
                file: "ga.wikipron-gle-broad.tsv",
                source: "wikipron gle_latn broad (human, 3-dialect)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source; the referee itself mixes 3 dialects. The espeak-ng-portable " +
        ...
        folds: [
            [
                /ⁱ/gu,
                "",
                "our i-offglide before a slender consonant (áit → ɑːⁱtʲ) — the referee omits it",
            ],
            [
                /[ɪi]/gu,
                "i",
                "short i / ɪ — the referee's coarse i vs our lax ɪ (Ó Siadhail standard)",
            ],
            ...
            [
                /[ɑa]/gu,
                "a",
                "the 3-dialect a/ɑ/ɑː variation (Connacht a, Munster ɑː)",
            ],
    ...
    ha: {
        referees: [
            {
                file: "ha.wikipron-hau-latn-broad.tsv",
                source: "wikipron hau_latn broad (human, tone-marked)",
                role: "primary",
            },
            {
                file: "ha.epitran-hau-Latn.tsv",
                source: "epitran hau-Latn (programmatic)",
                role: "secondary",
            },
        ],
        segmentJoin: true,
        folds: [
            [
                /ʔʲ/gu,
                "j",
                "glottalised ⟨ƴ⟩: our ʔʲ vs referee creaky j̰ (̰ stripped by the backbone)",
            ],
            [/ɸ/gu, "f", "⟨f⟩ realised [ɸ]~[f] — dialectal/allophonic"],
            [
                /ⁱ/gu,
                "i",
                "our superscript diphthong offglide (aⁱ) vs referee a i",
            ],
            ...
            [
                /^ʔ/gu,
                "",
                "epenthetic glottal onset on vowel-INITIAL words — allophonic; anchored so medial phonemic /ʔ/ (the ⟨'⟩ letter) still counts",
            ],
        ],
    },
    hi: {
        referees: [
            {
                file: "hi.wikipron-hin-deva-broad.tsv",
                source: "wikipron hin_deva broad (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "epitran hin-Deva doesn't perform Hindi schwa-deletion (writes every inherent अ), so it disagrees " +
        ...
        folds: [
            [
                /ɑ/gu,
                "a",
                "referee writes आ as ɑ(ː); we use a(ː) — same phoneme, notation",
            ],
            [
                /ᵊ/gu,
                "",
                "referee's epenthetic final schwa (pətɾᵊ) — we don't emit it",
            ],
    ...
    ja: {
        referees: [
            {
                file: "ja.wikipron-jpn-hira-narrow.tsv",
                source: "wikipron jpn_hira narrow (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; the narrow wikipron is the human transcription and epitran jpn is unreliable.",
        segmentJoin: true,
        folds: [
            [
                /ꜜ/gu,
                "",
                "pitch-accent downstep marker — the referee is toneless",
            ],
    ...
    kk: {
        referees: [
            {
                file: "kk.epitran-kaz-Cyrl.tsv",
                source: "epitran kaz-Cyrl (programmatic)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no human second source wired; wikipron kaz would be a better corroborator than epitran " +
            "(which merges ө/ү→ʏ and over-marks the е palatal onglide — the espeak-ng-portable kk work used wikipron).",
        folds: [
            [
                /ɫ/gu,
                "l",
                "dark-l is allophonic (harmony); epitran writes plain l",
            ],
            ...
            [
                /je/gu,
                "e",
                "epitran over-marks the е palatal onglide everywhere; [je] is word-initial-only in Kazakh",
            ],
            [
                /ij/gu,
                "əj",
                "epitran writes и as ij, ours as əj (reduced-vowel convention)",
            ],
        ],
    },
    ko: {
        referees: [
            {
                file: "ko.wikipron-kor-hang-narrow.tsv",
                source: "wikipron kor_hang narrow (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; epitran kor-Hang would corroborate the ㅓ/ㅏ vowel qualities.",
        segmentJoin: true,
        folds: [
    ...
    pt: {
        referees: [
            {
                file: "pt.wikipron-por.tsv",
                source: "wikipron por_latn_po broad (human)",
                role: "primary",
            },
            {
                file: "pt.gold-adjudicated.tsv",
                source: "adjudicated gold (open/close-vowel + x cases, our convention)",
                role: "secondary",
            },
        ],
        segmentJoin: true,
        folds: [
            ...
            [
                /tʃ/gu,
                "ʃ",
                "⟨ch⟩: Lisbon standard ʃ vs the referee's conservative t͡ʃ",
            ],
    ...
    ru: {
        referees: [
            {
                file: "ru.kaikki-rus.tsv",
                source: "kaikki rus (Wiktionary, CC-BY-SA)",
                role: "primary",
            },
            {
                file: "ru.gold-adjudicated.tsv",
                source: "adjudicated micro-gold (hand-transcribed, our convention)",
                role: "secondary",
            },
        ],
        folds: [
            [
                /[⁽⁾()]/gu,
                "",
                "kaikki optional-palatalization ⁽ʲ⁾ / optional-segment () markers",
            ],
            [/ˠ/gu, "", "velarization mark on dark l"],
            [
                /ʲ/gu,
                "",
                "palatalization: fold to compare the segmental skeleton (both mark it, differently placed)",
            ],
    ...
    si: {
        referees: [
            {
                file: "si.wikipron-sin.tsv",
                source: "wikipron sin_sinh_narrow (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; epitran sin would corroborate the retroflex mergers.",
        segmentJoin: true,
        folds: [
            ...
            [
                /[ʰʱ]/gu,
                "",
                "aspiration — ours keeps it (loan register), referee deaspirates",
            ],
            [/[əɐä]/gu, "a", "a/ə are allophones in Sinhala"],
            [
                /(.)\1+/gu,
                "$1",
                "geminate length vs doubling — both referee and ours inconsistent",
            ],
            [
                /wa$/gu,
                "w",
                "final-ව offglide: the schwa after ව→w is dialectally optional",
            ],
        ],
    },
    sv: {
        ...
        referees: [
            {
                file: "sv.wikipron-swe.tsv",
                source: "wikipron swe broad (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; epitran ships no Swedish. The NST lexicon is the pitch/" +
        ...
        folds: [
            [
                /²/gu,
                "",
                "accent-2 prosodeme marker — a pitch feature, deferred to Phase 2",
            ],
            [/¹/gu, "", "accent-1 prosodeme marker — deferred"],
            [
                /ʈ/gu,
                "rt",
                "retroflex ⟨rt⟩: ours assimilates (Central Standard), the broad referee often leaves r+t",
            ],
            ...
            [
                /tɕ/gu,
                "ɕ",
                "tje-sound: referee wobbles t͡ɕ ~ ɕ (tie already stripped) → our ɕ",
            ],
            [
                /æ/gu,
                "ɛ",
                "ä before r lowers to æ (ours, Central Standard); referee writes ɛ",
            ],
            [
                /œ/gu,
                "ø",
                "ö quality œ~ø (short/long, length already stripped) — notation",
            ],
        ],
    },
    ta: {
        referees: [
            {
                file: "ta.wikipron-tam-taml-broad.tsv",
                source: "wikipron tam_taml broad (human)",
                role: "primary",
            },
        ],
        secondaryGap:
            "epitran tam-Taml echoes untransliterated Tamil graphemes (e.g. visarga ஃ) into its output, so " +
        ...
        folds: [
            ...
            [
                /ᶦ/gu,
                "i",
                "our superscript diphthong offglide (maᶦ) vs referee ɐ ɪ̯",
            ],
            [
                /r$/gu,
                "ɾ",
                "word-final ⟨ர⟩ tap: our r vs referee ɾ — anchored so the medial ற/ர contrast still counts",
            ],
        ],
    },
    th: {
        ...
        referees: [
            {
                file: "th.wikipron-tha-thai-broad.tsv",
                source: "wikipron tha_thai broad (human, tone-marked)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; a pronunciation lexicon (kaikki tha) would corroborate the Sanskrit readings.",
        segmentJoin: true,
        folds: [
            [
                /ʔ/gu,
                "",
                "glottal coda on open short syllables — allophonic; referee writes an unreleased stop or nothing",
            ],
        ],
    },
    tr: {
        referees: [
            {
                file: "tr.wikipron-tur-latn-broad.tsv",
                source: "wikipron tur_latn broad (human)",
                role: "primary",
            },
            {
                file: "tr.epitran-tur-Latn.tsv",
                source: "epitran tur-Latn (programmatic)",
                role: "secondary",
            },
        ],
        segmentJoin: true,
    ...
    vi: {
        referees: [
            {
                file: "vi.wikipron-vie-latn-hanoi-narrow.tsv",
                source: "wikipron vie_hanoi narrow (human, Northern)",
                role: "primary",
            },
            {
                file: "vi.epitran-vie-Latn.tsv",
                source: "epitran vie-Latn (programmatic)",
                role: "secondary",
            },
        ],
        segmentJoin: true,
        folds: [
            [
                /ˀ/gu,
                "",
                "our glottalised-tone marker (creaky ˀ) — realises the referee's ʔ coda / glottal-tone feature",
            ],
            [
                /ʔ/gu,
                "",
                "referee's glottal-stop coda on broken/creaky tones — the same feature we mark on the tone",
            ],
        ],
    },
    zu: {
        referees: [
            {
                file: "zu.epitran-zul-Latn.tsv",
                source: "epitran zul-Latn (programmatic)",
                role: "primary",
            },
        ],
        secondaryGap:
            "no independent second source wired; a curated Nguni-tone gold would corroborate the clicks.",
        folds: [
            [/ʼ/gu, "", "ejective — we keep it, epitran drops it"],
            [
                /k(?=[ǀǃǁǂʘ])/gu,
                "",
                "our click k-release (kǀ) vs epitran bare click (ǀ)",
            ],
            ...
            [
                /ɛ/gu,
                "e",
                "mid-vowel raising is allophonic (ɛ↔e); neither transcription is wrong",
            ],
