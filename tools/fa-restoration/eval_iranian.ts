 ...
 * (fa_gold_aligned.tsv = word⇥fa-engine-ipa⇥gold, from tools/fa-restoration/fa-abjad-ipa-gold.tsv via the fa engine.)
 *   npx tsx tools/fa-restoration/eval_iranian.ts <dir-with-fa_test.tsv>
 *
