 ...
 *
 * VALIDATION (run against tools/fa-restoration/fa-abjad-ipa-gold.tsv): the derived Persian IPA matches fa's own
 ...
 *
 *   npx tsx tools/fa-restoration/tajik-align.ts   # prints the fa-gold validation
 *
