 ...
 *   npx tsx tools/fa-restoration/align_shahnameh.ts <dir-with-fa_shahnameh.txt+tg_shahnameh.txt>
 */
import { translitToSkeleton, tajikIpaToPersian } from "../../fa-restoration/tajik-align.ts";
