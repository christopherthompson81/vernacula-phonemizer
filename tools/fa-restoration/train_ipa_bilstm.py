...
This is where we DIVERGE from the tools/arabic-restorer/ pipeline (skeleton→harakat→g2p→IPA): the harakat
...
Inputs (regenerate the fa-engine alignment with tsx — see train_shortvowel notes / the investigation doc):
  <fa_gold_aligned.tsv>  word<TAB>fa-engine-ipa<TAB>gold-ipa(|-variants)   (from tools/fa-restoration/fa-abjad-ipa-gold.tsv)
