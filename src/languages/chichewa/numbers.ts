 ...
 * "5 and N" (zisanu ndi chimodzi = 6). Simplified counting form (khumi = 10, makumi = tens, zana = 100); the full
 * noun-class concord is contextual. Covers 0 … <10⁶; larger / non-finite → digit-by-digit. Numbers are unmeasured
 * (the referees are word-only) — best-effort.
 */
