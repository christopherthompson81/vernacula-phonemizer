/**
 * The consolidated hand-authored guarani data tables (guarani.jsonc).
 *
 ...
 */
import type { GuaraniDef } from "./guarani.ts";
import { loadManifest } from "../../core/loadManifest.ts";

export const MANIFEST = loadManifest<GuaraniDef>(import.meta.url, "guarani.jsonc");
