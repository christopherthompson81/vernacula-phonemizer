 ...
 * practical orthography, canonical IPA, espeak-independent. The fleet's FIRST Mixe-Zoquean language. The g2p is
 ...
 * (coarse, independent) — inventory-only. See docs/investigations/mto_native_bringup_investigation.md.
 */
...
const TOKEN = /([a-zäëöüáéíóúÄËÖǛ-ͯʼꞌ'’`-]+)|(\d+)|([.?!,;:…])/giu;
