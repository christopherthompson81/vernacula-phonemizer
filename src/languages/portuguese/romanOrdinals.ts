...
export const ROMAN_POLICY: Policy = {
     ...
     */
    ordinalAfter:
        /^(aniversário|centenário|congresso|encontro|festival|campeonato|certame|concurso|prémio|premio|salão|simpósio|colóquio|seminário|torneio|fórum|ciclo|volume|capítulo|tomo|canto|ato|acto|artigo|batalhão|regimento|governo)$/iu,
};
