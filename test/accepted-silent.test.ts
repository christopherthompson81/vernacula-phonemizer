...
describe("ACCEPTED_SILENT is a baseline, not a suppression", () => {
    ...
    test("the table covers the sweep's whole residual, per class", () => {
        ...
        expect(Object.keys(ACCEPTED_SILENT).sort()).toEqual(["ak", "bal", "bar", "bm", "cdo", "ceb", "cjy", "gan", "gu", "hak", "he", "hi", "hsn", "ht", "jv", "km", "kmr", "kn", "ln", "lo", "mad", "mg", "mr", "my", "nan", "nya", "ps", "rn", "rw", "si", "so", "su", "syl", "ta", "ti", "tl", "ug", "wuu", "xh", "za"]);
