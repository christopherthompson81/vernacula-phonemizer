...
// validated against wikipron ast_latn_broad (4170 human headwords) — 97.8% FOLDED / 99.6% symbol, with stress
// and spirantization folded. ⚠ That is the ONLY referee available for ast, so the score has no independent
