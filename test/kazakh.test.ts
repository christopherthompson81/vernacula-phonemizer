...
// TEXT NORMALIZATION (src/languages/kazakh/normalize.ts) — the pre-tokenizer pass. The
// DEFINING rule  is the case suffix after a digit: the suffix must AGREE with the word via vowel
