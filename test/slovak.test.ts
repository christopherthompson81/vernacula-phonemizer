...
describe("Slovak text normalization", () => {
    ...
    test("licensed ordinals agree with the noun that follows", () => {
        ...
        // outside the licensor list → the masculine nominative citation form (absence is not evidence of correctness
    ...
    // The check that matters : a `N.` that is a SENTENCE END must not be claimed. Slovak
