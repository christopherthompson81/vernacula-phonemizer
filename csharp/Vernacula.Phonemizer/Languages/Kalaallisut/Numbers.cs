...
public static class Numbers
{
    ...
    /**
     * Non-negative integer → Kalaallisut cardinal words. **0–12 native Greenlandic, 13+ Danish** (see the header
     * for the corpus evidence). `million`/`milliard` are separate words; everything below 10⁶ is one solid Danish
     * word. ≥10¹² or non-safe → digit-by-digit.
     */
