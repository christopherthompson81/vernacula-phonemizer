...
public static class Bootstrap
{
    ...
    public static void EnsureRegistered()
    {
        lock (Gate)
        {
            ...
            Balochi.BalochiPhonemizer.RegisterSelf();
            ...
            Luxembourgish.LuxembourgishPhonemizer.RegisterSelf();
