...
public static class Normalize
{
     ...
     *  ⚠ WRITTEN AS ESCAPES, NOT LITERALS: the class is four COMBINING marks and a private-use code point, none of
     *  which survive a round-trip through a shell heredoc or render distinguishably in an editor. The TS source is
     *  `/[ً-ْٰ\u{E000}]/gu` — U+064B…U+0652, U+0670, U+E000. */
    ...
    // The step patterns, hoisted to statics (the TS builds them inline in the returned closure; JsRegex.Compile
    ...
    public static Func<string, string> MakePersianNormalizer(NumbersDef numbers)
    {
        ...
        return input =>
        {
            ...
            //      (`whole` is the JS replacer's fourth argument — the subject string, snapshotted here because `s`
