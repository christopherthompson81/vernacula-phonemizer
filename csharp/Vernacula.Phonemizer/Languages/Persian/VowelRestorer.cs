...
public static class VowelRestorer
{
    ...
    private sealed class Loaded : IFaVowelRestorer
    {
        ...
        {
            // B = 5 beam width (+~1.5pp over greedy on the held-out); the decode itself is the shared
            // ContextRestorer.BeamDecode — see its note on why the two copies were factored into one.
