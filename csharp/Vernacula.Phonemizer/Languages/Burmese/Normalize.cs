...
public static class Normalize
{
    ...
    // ⚠ THE ZERO-WIDTH CLASS IS ALL ESCAPES. Every member is invisible in a source file — ZWSP, ZWNJ, ZWJ, the
    // word joiner and the BOM — and Burmese uses ZWSP *inside* words, so a class that lost a member here would
    // leave a token split for the segmenter with nothing visible to explain it.
