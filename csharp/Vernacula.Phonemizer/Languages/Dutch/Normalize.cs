...
public static class Normalize
{
    ...
    // ⚠ THE SPACE CLASSES CARRY A NON-BREAKING SPACE (U+00A0) BESIDE THE PLAIN ONE, written as an escape so an
    // editor that folds it cannot narrow the class in silence.
    ...
    public static string NormalizeDutch(string input)
    {
        ...
        // hands an EMPTY string, so the group's success is what decides.
