...
//
// ⚠ RUN THIS ON THE MACHINE THAT GENERATED THE GOLDENS. The goldens are async-mode output and 74 of 189
// languages depend on ONNX, whose int8 kernels dispatch by instruction set — so on other hardware this
// reports a divergence between the two ENGINES that does not exist. Measured Intel Comet Lake against an
// AMD EPYC runner: 44 rows of 36,495. Same-machine comparison is the contract, not a caveat (#1287);
// the "N languages byte-identical" line below means "on this machine". See csharp/PORTING.md.
//
