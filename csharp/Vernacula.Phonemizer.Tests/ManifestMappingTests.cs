...
public class ManifestMappingTests
{
    ...
    [Fact]
    public void SlovakManifestIsFullyMapped() =>
        AssertFullyMapped("languages/slovak", "slovak.jsonc", Languages.Slovak.Manifest.MANIFEST,
            "language", "name", "script", "provenance", "convention");
    ...
    [Fact]
    public void WelshManifestIsFullyMapped() =>
        AssertFullyMapped("languages/welsh", "welsh.jsonc", Languages.Welsh.Manifest.MANIFEST,
            "language", "name", "script", "provenance");
